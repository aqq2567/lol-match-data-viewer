...
const ALL_ADVANCED_METRICS: MetricDef[] = [
  ...
  { key: 'totalSpellCasts', label: '技能释放频率', colorClass: 'cat-purple', getter: (s) => s.spell_casts.q + s.spell_casts.w + s.spell_casts.e + s.spell_casts.r, fmt: (v) => fmtNum(v) },
